// app/api/delete-account-vixoai/route.ts
...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      from: `"VixoAI – Account Deletion" <${SMTP_USER}>`,
      to: ADMIN_EMAIL,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
          <div style="background: #e11d48; padding: 20px 24px;">
            ...
            <p style="color: #fecdd3; margin: 4px 0 0; font-size: 13px;">VixoAI – AI Video & Image Generator · UK Developers</p>
          </div>
          ...
          <div style="padding: 14px 24px; background: #f9fafb; border-top: 1px solid #e5e7eb; text-align: center;">
            <p style="margin: 0; font-size: 12px; color: #9ca3af;">This is an automated notification from VixoAI · UK Developers</p>
          </div>
        </div>
      `,
    });
    ...
    await transporter.sendMail({
      from: `"UK Developers – VixoAI" <${SMTP_USER}>`,
      to: email,
      subject: "Your VixoAI account deletion request has been received",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
          <div style="background: #111827; padding: 20px 24px;">
            <h2 style="color: white; margin: 0; font-size: 18px;">VixoAI – AI Video & Image Generator</h2>
          ...
          <div style="padding: 28px 24px; background: #fff;">
            ...
            <p style="font-size: 14px; color: #374151; line-height: 1.6;">
              We have received your request to permanently delete your <strong>VixoAI</strong> account associated with <strong>${email}</strong>.
            </p>
          ...
          <div style="padding: 14px 24px; background: #f9fafb; border-top: 1px solid #e5e7eb; text-align: center;">
            <p style="margin: 0; font-size: 12px; color: #9ca3af;">© 2026 UK Developers · VixoAI – AI Video & Image Generator</p>
          </div>
        </div>
      `,
    });
