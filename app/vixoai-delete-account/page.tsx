...
function AccountDeletionForm() {
  ...
  const handleSubmit = async () => {
    ...
    setError("");
    try {
      const res = await fetch("/api/delete-account-vixoai", {
        method: "POST",
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div>
          <label className="block text-xs font-extrabold text-gray-600 uppercase tracking-wider mb-1.5">
            Email address on your VixoAI account <span className="text-rose-500">*</span>
          </label>
          <input
            type="email"
            value={email}
      ...
      <p className="text-xs font-semibold text-gray-500 text-center">
        This request is submitted to <strong>UK Developers</strong> for <strong>VixoAI – AI Video & Image Generator</strong>. We will respond within 30 days.
      </p>
    </div>
  );
}
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          This Privacy Policy explains how <strong>UK Developers</strong> ("we", "us", "our") collects, uses, stores, and protects your personal information when you use <strong>VixoAI – AI Video & Image Generator</strong> ("the App"). By using the App, you agree to the terms described here.
        </p>
        <p>
        ...
        <p className="text-sm font-semibold text-gray-600 border-2 border-gray-200 bg-white rounded-xl px-4 py-3 mt-2">
          Last updated: <span className="text-gray-900 font-bold">July 2026</span> &nbsp;·&nbsp; Applies to: <span className="text-gray-900 font-bold">VixoAI Android app (Google Play)</span>
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p>VixoAI uses AI models to generate videos and images from your text prompts. Here is how your content is handled:</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          VixoAI is not intended for children under the age of 13 (or 16 in the EU). We do not knowingly collect personal data from children.
        </p>
        <p className="mt-3">
      ...
      <>
        <div className="rounded-xl border-2 border-rose-200 bg-rose-50 px-4 py-3 mb-5 flex items-start gap-3">
          ...
          <p className="text-sm font-bold text-rose-800">
            This is the official account deletion page for <strong>VixoAI – AI Video & Image Generator</strong> published by <strong>UK Developers</strong> on Google Play (<span className="font-mono text-xs font-bold break-all">com.bhola.vixoaiapp</span>). Submit the form below to permanently delete your account and all associated data.
          </p>
        </div>

        <p className="text-sm font-semibold text-gray-700 mb-4">
          Under UK GDPR and Google Play's User Data policy, you have the right to request deletion of your <strong>VixoAI</strong> account and all personal data held by <strong>UK Developers</strong> at any time. You may also delete your account directly inside the app via <span className="font-extrabold text-gray-900">Settings → Account → Delete Account</span>.
        </p>
        ...
        <div className="mt-5 rounded-xl border-2 border-gray-200 bg-gray-50 px-4 py-4 space-y-3">
          ...
          {[
            ...
            "Your VixoAI account, generated videos, images, and prompts will be permanently deleted within 30 days.",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs font-bold text-gray-500 truncate" style={{ fontFamily: "monospace" }}>
            Privacy Policy · AI Video & Image Generator
          </p>
        </div>
      ...
      <footer className="border-t-2 border-gray-200 mt-8 sm:mt-10 py-5 sm:py-6 px-4 sm:px-6 text-center" style={{ backgroundColor: "#ffffff" }}>
        <p className="text-xs font-bold text-gray-500">© 2026 UK Developers · VixoAI – AI Video & Image Generator · All rights reserved</p>
      </footer>
