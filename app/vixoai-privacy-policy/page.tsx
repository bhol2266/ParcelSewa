...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          This Privacy Policy explains how <strong>UK Developers</strong> ("we", "us", "our") collects, uses, stores, and protects your personal information when you use <strong>VixoAI – AI Video & Image Generator</strong> ("the App"). By downloading or using the App, you agree to the practices described in this policy.
        </p>
        <p>
        ...
        <div className="mt-3 rounded-xl border-2 border-gray-200 bg-white px-4 py-3 space-y-1.5">
          <div className="flex flex-wrap gap-x-6 gap-y-1 text-sm">
            <span className="text-gray-500 font-semibold">Last updated: <span className="text-gray-900 font-bold">July 2026</span></span>
            <span className="text-gray-500 font-semibold">Platform: <span className="text-gray-900 font-bold">Android (Google Play)</span></span>
            <span className="text-gray-500 font-semibold">Package: <span className="font-mono text-xs text-gray-900 font-bold">com.bhola.vixoaiapp</span></span>
          </div>
        </div>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <p>We use your information solely to operate and improve VixoAI:</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>VixoAI uses AI models to generate videos and images from your text prompts. Here is how your content is handled during that process:</p>
      ...
      <>
        <div className="rounded-xl border-2 border-amber-200 bg-amber-50 px-4 py-3 flex items-start gap-3 mb-4">
          ...
          <p className="text-sm font-bold text-amber-800">
            VixoAI is <strong>not intended for children under 13</strong> (or under 16 in the European Union). We do not knowingly collect personal data from minors.
          </p>
        </div>
        <p className="text-sm font-semibold text-gray-700">
        ...
        <div className="mt-4 rounded-xl border-2 border-gray-200 bg-white overflow-hidden">
          ...
          <div className="px-5 py-4 flex items-center gap-3 border-b-2 border-gray-100">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-gray-500">VixoAI – AI Video & Image Generator</p>
            </div>
          </div>
          {/* Contact rows */}
          {[
      ...
      <footer className="border-t-2 border-gray-200 mt-8 sm:mt-10 py-5 sm:py-6 px-4 sm:px-6" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs font-bold text-gray-500 text-center sm:text-left">
            © 2026 UK Developers · VixoAI – AI Video & Image Generator · All rights reserved
          </p>
          <Link
            href="/vixoai-delete-account"
