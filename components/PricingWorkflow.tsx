...
const PricingWorkflow = () => {
    return (
        <section className="w-full max-w-3xl mx-auto px-6 py-12">
            ...
            {/* Heading */}
            <h2 className="text-4xl md:text-5xl font-bold text-[#0C2F4A] mt-6 leading-tight">
                Know your final <br /> cost before you say <span className="text-orange-500">“yes”</span>.
            </h2>

            {/* Description */}
            <p className="text-[#1c3e57]/80 mt-6 text-lg leading-relaxed">
            ...
            {/* Bullet points */}
            <ul className="mt-6 space-y-4 text-[#0c2f4a] text-lg">
            ...
            {/* Quote box mockup */}
            <div className="mt-10 bg-white shadow-xl rounded-3xl p-6 border border-gray-100">
